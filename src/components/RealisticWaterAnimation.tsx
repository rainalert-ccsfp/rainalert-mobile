...
type RealisticWaterAnimationProps = {
  fillPercentage?: number // 0 to 100
  duration?: number
  containerStyle?: any
}

const RealisticWaterAnimation = ({
  fillPercentage = 100,
  duration = 10000,
  containerStyle,
}: RealisticWaterAnimationProps) => {
    ...
    <View style={[styles.container, containerStyle]}>
      ...
      >
        ...
        <View style={[styles.water, { backgroundColor: theme.colors.water }]}>
          ...
          >
            <View style={[styles.waveShape, { backgroundColor: theme.colors.waterDark, opacity: 0.6 }]} />
          </Animated.View>
...
export default RealisticWaterAnimation
